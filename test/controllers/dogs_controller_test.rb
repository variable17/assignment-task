...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { age: @dog.age, image_url: @dog.image_url, name: @dog.name } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { age: @dog.age, image_url: @dog.image_url, name: @dog.name } }
